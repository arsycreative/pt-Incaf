...
export const FEATURED_PRODUCTS = [
  {
    name: 'Fulvic Acid',
    description: 'Biostimulan tanaman berbasis asam fulvat untuk penyerapan nutrisi optimal dan stimulasi pertumbuhan akar.',
    category: 'Fertilizer Speciality',
    categoryColor: 'bg-emerald-500',
    origin: 'China',
    image: '/images/products/highlight/fulvic_acid.jpeg',
    href: '/products/fertilizer',
  },
  {
    name: 'Amino Acid Fertilizer',
    description: 'Pupuk cair & powder berbasis asam amino untuk peningkatan vigor, ketahanan stress, dan kualitas hasil panen.',
    category: 'Fertilizer Speciality',
    categoryColor: 'bg-emerald-500',
    origin: 'China',
    image: '/images/products/highlight/mmino_acid_fertilizer.jpeg',
    href: '/products/fertilizer',
  },
  {
    name: 'Potassium Humate',
    description: 'Humat kalium konsentrasi tinggi untuk pembenah tanah, meningkatkan Cation Exchange Capacity (CEC) dan struktur tanah.',
    category: 'Fertilizer Speciality',
    categoryColor: 'bg-emerald-500',
    origin: 'China',
    image: '/images/products/highlight/potassium_humate.jpeg',
    href: '/products/fertilizer',
  },
  {
    name: 'Potassium Silicate',
    description: 'Silikat kalium cair untuk penguatan dinding sel tanaman, meningkatkan ketahanan terhadap hama, penyakit, dan kondisi kering.',
    category: 'Fertilizer Speciality',
    categoryColor: 'bg-emerald-500',
    origin: 'China',
    image: '/images/products/highlight/potassium_silicate.jpeg',
    href: '/products/fertilizer',
  },
  {
    name: 'Sodium Humate (ex Zhengli)',
    description: 'Sodium humat premium grade dari produsen Zhengli untuk formulasi pupuk granular, aplikasi tanah, dan soil conditioner.',
    category: 'Fertilizer Speciality',
    categoryColor: 'bg-emerald-500',
    origin: 'China',
    image: '/images/products/highlight/sodium_humate_ex_zhengli.jpeg',
    href: '/products/fertilizer',
  },
]
